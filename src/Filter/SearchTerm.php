 ...
 * SearchTerm filter
 */
class SearchTerm implements FilterInterface
{
    /**
    ...
    /**
     * Returns the search value. Might come from user input. So be careful.
     *
     * @return string
     */
    public function searchTerm(): null|string
    {
    ...
    {
        return is_null($this->searchTerm) ? false : true;
    }
    ...
    public function apply(InputInterface $input, SearchInterface $search): void
    {
        ...
        $searchTerm = $input->get($this->name());
    ...
    public function render(ViewInterface $view): string
    {
        ...
        $attributes = [
            ...
            'autocorrect' => 'off',
            'spellcheck' => 'false',
            'id' => $form->nameToId($this->name()),
        ];
        
        if ($this->placeholder) {
            $attributes['placeholder'] = $view->trans($this->placeholder);
        }
